...
const faqs = [
  ...
  {
    value: 'item-2',
    question: 'מהם יתרונות השימוש בפלטפורמת Megatec?',
    answer:
  ...
  {
    value: 'item-3',
    question: 'כיצד Megatec מטפלת באבטחה ובעלות על נתונים?',
    answer:
  ...
  {
    value: 'item-4',
    question: 'האם Megatec יכולה להתממשק עם מערכות אחרות?',
    answer:
      'כן, Megatec תוכננה להתממשק עם מערכות פרויקטים ארגוניות אחרות כמו כלי תזמון, מערכות ERP וכלי ניתוח. הדבר מתבצע באמצעות ממשקי API ותהליכי החלפת נתונים סטנדרטיים כדי לאפשר בקרות ודיווחים רחבים יותר על הפרויקט.',
  },
  {
    value: 'item-5',
      ...
      <div className="container mx-auto max-w-4xl">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-6 text-lg leading-relaxed text-muted-foreground">
            מצא תשובות לשאלות נפוצות על אופן פעולת Megatec וכיצד היא יכולה להועיל לפרויקטים שלך.
          </p>
        </div>
